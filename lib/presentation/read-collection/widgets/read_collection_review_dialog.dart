...
class ReadCollectionReviewDialog extends StatefulWidget {
  const ReadCollectionReviewDialog({
    super.key,
  ...
  @override
  State<ReadCollectionReviewDialog> createState() => _ReadCollectionReviewDialogState();
}

class _ReadCollectionReviewDialogState extends State<ReadCollectionReviewDialog> {
