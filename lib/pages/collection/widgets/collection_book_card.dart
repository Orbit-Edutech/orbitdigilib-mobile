...
class CollectionBookCard extends StatelessWidget {
  const CollectionBookCard({super.key, required this.status});
            ...
            Expanded(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      "Lorem Ipsum Dolor sit Amet LOREM123",
