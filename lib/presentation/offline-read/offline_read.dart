...
import '../read/widgets/read_search_toolbar.dart';
import 'controller/offline_read_controller.dart';
import 'widgets/offline_read_appbar.dart';

class OfflineReadPage extends StatefulWidget {
  const OfflineReadPage({super.key});

  @override
  State<OfflineReadPage> createState() => _OfflineReadPageState();
}
...
class _OfflineReadPageState extends State<OfflineReadPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const OfflineReadAppBar(),
      body: SafeArea(
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Obx(() {
                ...
                if (isOnSearch) {
                  // Custom Search Toolbar from syncfusion_flutter_pdfviewer
