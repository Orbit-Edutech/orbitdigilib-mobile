...
class ModelChangeAccess {
  ...
  factory ModelChangeAccess.fromRawJson(String str) => ModelChangeAccess.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ModelChangeAccess.fromJson(Map<String, dynamic> json) => ModelChangeAccess(
        id: json["id"],
