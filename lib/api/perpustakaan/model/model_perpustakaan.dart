...
class Perpustakaan {
  ...
  final bool? isAktif;
  final Alamat? alamat;
  final AssetLogo? assetTataTertib;
  ...
  Perpustakaan copyWith({
    ...
    AssetLogo? assetTataTertib,
      ...
      Perpustakaan(
        ...
        assetTataTertib: assetTataTertib ?? this.assetTataTertib,
      );
  ...
  factory Perpustakaan.fromJson(Map<String, dynamic> json) => Perpustakaan(
        ...
        assetTataTertib: json["assetTataTertib"] == null ? null : AssetLogo.fromJson(json["assetTataTertib"]),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "assetTataTertib": assetTataTertib?.toJson(),
      };
}
