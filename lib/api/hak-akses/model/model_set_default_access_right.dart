...
class ModelSetDefaultAccessRight {
  final String? id;
  final User? user;
  final Perpustakaan? perpustakaan;
  final bool? hakAkses;

  ModelSetDefaultAccessRight({
    this.id,
    this.user,
    this.perpustakaan,
    this.hakAkses,
  ...
  factory ModelSetDefaultAccessRight.fromRawJson(String str) => ModelSetDefaultAccessRight.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ModelSetDefaultAccessRight.fromJson(Map<String, dynamic> json) => ModelSetDefaultAccessRight(
        id: json["id"],
