...
import 'widgets/read_collection_app_bar.dart';
import 'widgets/read_collection_search_toolbar.dart';

class ReadCollectionPage extends StatefulWidget {
  const ReadCollectionPage({super.key});

  @override
  State<ReadCollectionPage> createState() => _ReadCollectionPageState();
}
...
class _ReadCollectionPageState extends State<ReadCollectionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const ReadCollectionAppBar(),
      body: SafeArea(
        child: Column(
