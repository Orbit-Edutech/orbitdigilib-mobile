  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onHorizontalDragEnd: (DragEndDetails details) {
        if ((details.primaryVelocity ?? 0) < 0 && indexController.persistentController.index != 4 - 1) {
          indexController.persistentController.index++;
        } else if ((details.primaryVelocity ?? 0) > 0 && indexController.persistentController.index != 0) {
          indexController.persistentController.index--;
        }
        onItemSelected(indexController.persistentController.index);
      },
